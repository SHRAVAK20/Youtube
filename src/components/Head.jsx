    ...
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
      ...
      <div className="col-span-10 px-10">
        <div>
          ...
          />
          <button className="border-2 border-gray-400 p-5 py-2 rounded-r-full bg-gray-100">
            🔍
          </button>
        </div>
        {showSuggestion && (
          <div className="absolute bg-white py-2 px-2 w-[27rem] rounded-lg border border-gray-100">
            <ul>
              {suggestion &&
                suggestion.map((s) => (
